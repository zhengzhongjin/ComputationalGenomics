...
//                    args[2] = queryLength + "";
                    run.setParameter(Mode.OPT, port, bandWidth, Arrays.copyOfRange(args, 1, args.length), allkeys, keys, keyIndex);
        ...
        run.setParameter(Mode.OPT, port, bandWidth, Arrays.copyOfRange(args, 1, args.length), data, keys, 0);
