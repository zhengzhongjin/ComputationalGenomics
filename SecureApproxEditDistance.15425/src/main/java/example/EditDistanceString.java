...
public class EditDistanceString {
    ...
    static public <T> T[] compute(CompEnv<T> gen, T[] inputA, T[] inputB, int kband) {
        //(T[]) new Object[];
...
//        return ret;
        return new StringLib<T>(gen).editDistanceKBand(inputA, inputB, kband);//editDistance
    }
...
//            System.out.println("Input: "+Utils.toString(gen.outputToAlice(inputA)));
        ...
        public void secureCompute(CompEnv<T> gen) {
            scResult = compute(gen, inputA, inputB, bandWidth);
        }
